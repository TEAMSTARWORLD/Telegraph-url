...
# ##Credits - [GetAnyID bot by star TiPs] (https://github.com/TEAMSTARWORLD/Telegraph-url)
...
@starAnyIDBot.on_message(filters.command('start') & filters.private)
...
🏠 | [Home](https://t.me/TEACH_TEAMOP)
            """
    await starAnyIDBot.send_message(message.chat.id, text, disable_web_page_preview=True)


@starAnyIDBot.on_message(filters.command('id'))
